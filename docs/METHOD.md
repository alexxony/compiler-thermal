...
sibling projects, gpu-solver-loop, hbm-build). It is a record of five rules followed during the
...
compiler-thermal follows all five rules and is one of the two repos documenting verifier
isolation directly — see `JOURNAL.md:45` ("P10 independent verification closed (verifier
p10-verify)") and the second independent cross-check recorded 2026-07-22T22:20:00+09:00.
